...
function myButtonClicked() {
  ...
  document.getElementById('answer').innerHTML = 'Your pay will be: $' + takeHomeSalary.toFixed(2)
  document.getElementById('answer-two').innerHTML = 'The government gets: $' + moneyTaxed.toFixed(2)
}